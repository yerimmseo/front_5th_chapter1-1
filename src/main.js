...
const Header = ({ isLoggedIn }) => {
  ...
  const nav = isLoggedIn
    ? /*html*/ `
      <li><a href="/profile" class="text-${currentPathName === "/profile" ? "blue" : "gray"}-600">프로필</a></li>
      <li><a href="#" id="logout" class="text-gray-600">로그아웃</a></li>
    `
    : /*html*/ `
      <li><a href="/login" class="text-${currentPathName === "login" ? "blue" : "gray"}-600">로그인</a></li>
    `;
  ...
  if (loginForm) {
    loginForm.addEventListener("submit", (e) => {
      ...
      if (username) {
        ...
        state.user = { username: username, email: "", bio: "" };
